// Auto-generated feature route: vertical-meeting-intel
// Domain: vertical meeting intelligence agent — Capability: tailoring intelligence for HIPAA, sales, or technical contexts
// Mounted under: /api/vertical-meeting-intel
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a vertical meeting intelligence agent. Your task is tailoring intelligence for HIPAA, sales, or technical contexts. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
