// Auto-generated feature route: live-facilitator-agent
// Domain: agentic live meeting facilitator — Capability: producing talking points, off-topic flags, in-meeting summaries
// Mounted under: /api/live-facilitator-agent
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a agentic live meeting facilitator. Your task is producing talking points, off-topic flags, in-meeting summaries. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
