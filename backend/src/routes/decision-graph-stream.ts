// Auto-generated feature route: decision-graph-stream
// Domain: decision intelligence agent — Capability: tracking decision rationale across a meeting graph
// Mounted under: /api/decision-graph-stream
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a decision intelligence agent. Your task is tracking decision rationale across a meeting graph. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
