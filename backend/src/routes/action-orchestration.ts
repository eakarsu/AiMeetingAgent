// Auto-generated feature route: action-orchestration
// Domain: autonomous action item orchestrator — Capability: creating calendar blocks for owners
// Mounted under: /api/action-orchestration
...
router.post('/run', async (req: Request, res: Response) => {
  try {
    ...
    const systemPrompt = `You are a autonomous action item orchestrator. Your task is creating calendar blocks for owners. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.`;
