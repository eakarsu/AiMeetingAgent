...
// Streaming
// Streaming decision intelligence tracking rationale across meeting graph

export default function GapStreaming() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-streaming', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Streaming</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming decision intelligence tracking rationale across meeting graph</p>
