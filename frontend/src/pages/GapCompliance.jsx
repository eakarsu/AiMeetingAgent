...
// Compliance
// Compliance recording (regulated industries)

export default function GapCompliance() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-compliance', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Compliance</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Compliance recording (regulated industries)</p>
