...
// Long Term
// Long-term analytics dashboard (trends)

export default function GapLongTerm() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-long-term', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Long Term</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Long-term analytics dashboard (trends)</p>
