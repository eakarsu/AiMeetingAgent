...
// Full Text
// Full-text search across meeting library

export default function GapFullText() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-full-text', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Full Text</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Full-text search across meeting library</p>
