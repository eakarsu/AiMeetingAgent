...
// Agentic
// Agentic live meeting facilitator (talking points, off-topic flags, in-meeting summary)

export default function GapAgentic() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-agentic', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Agentic</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic live meeting facilitator (talking points, off-topic flags, in-meeting summary)</p>
