...
// Video
// Video recording & playback (transcript-only currently)

export default function GapVideo() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-video', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Video</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Video recording & playback (transcript-only currently)</p>
